// Package main is the entry point for the scaffolded-basic Beluga AI
// project. It was generated by `beluga init scaffolded-basic` on
...
// newAgent constructs the scaffolded-basic-agent agent with its persona and
...
func newAgent(model llm.ChatModel) agent.Agent {
	return agent.New("scaffolded-basic-agent",
		agent.WithLLM(model),
...
func main() {
	...
	shutdown, err := o11y.BootstrapFromEnv(ctx, "scaffolded-basic")
	if err != nil {
