// Package main is the entry point for the dev-loop-demo Beluga AI
// project. It was generated by `beluga init dev-loop-demo` on
...
// newAgent constructs the dev-loop-demo-agent agent with its persona and
...
func newAgent(model llm.ChatModel) agent.Agent {
	return agent.New("dev-loop-demo-agent",
		agent.WithLLM(model),
...
func main() {
	...
	shutdown, err := o11y.BootstrapFromEnv(ctx, "dev-loop-demo")
	if err != nil {
